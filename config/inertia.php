...
return [
    ...
    */
    ...
    'ssr' => [
        // Off by default: there is no resources/js/ssr.tsx entry point, so
        // leaving this on makes every request attempt a doomed connection to
        // the SSR server before falling back to client rendering.
